...
public class Stromdichte extends Activity implements View.OnClickListener{
	Button senden;
	WakeLock wL;
	@Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Fullscreen ende
        setContentView(R.layout.stromdichte);
        initializeVars();
    ...
    public void onClick(View v) {
    	...
    	intEmail.putExtra(android.content.Intent.EXTRA_SUBJECT, "Fehler/Ergänzung in Stromdichte");
