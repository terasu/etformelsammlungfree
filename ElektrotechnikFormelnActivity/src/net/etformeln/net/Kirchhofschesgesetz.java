...
public class Kirchhofschesgesetz extends Activity implements View.OnClickListener{
	Button senden;
	WakeLock wL;
	@Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Fullscreen ende
		setContentView(R.layout.kirchhofschesgesetz);
		initializeVars();
    ...
    public void onClick(View v) {
    	...
    	intEmail.putExtra(android.content.Intent.EXTRA_SUBJECT, "Fehler/Ergänzung in Kirchhofsches Gesetz");
