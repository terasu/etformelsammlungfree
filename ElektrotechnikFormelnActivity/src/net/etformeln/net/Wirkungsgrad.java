...
public class Wirkungsgrad extends Activity implements View.OnClickListener{
	Button senden;
	WakeLock wL;
	@Override
    public void onCreate(Bundle savedInstanceState) {
      ...
      //Fullscreen start
        ...
        //Fullscreen ende
        setContentView(R.layout.wirkungsgrad);
        initializeVars();
    ...
    public void onClick(View v) {
    	...
    	intEmail.putExtra(android.content.Intent.EXTRA_SUBJECT, "Fehler/Ergänzung in Wirkungsgrad");
