...
public class Waerme extends Activity implements View.OnClickListener{
	Button senden;
	WakeLock wL;
	@Override
    public void onCreate(Bundle savedInstanceState) {
      ...
      //Fullscreen start
        ...
        //Fullscreen ende
        setContentView(R.layout.waerme);
        initializeVars();
    ...
    public void onClick(View v) {
    	...
    	intEmail.putExtra(android.content.Intent.EXTRA_SUBJECT, "Fehler/Ergänzung in Wärme");
