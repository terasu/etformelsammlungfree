...
public class Transformator extends Activity implements View.OnClickListener{
	Button senden;
	WakeLock wL;
	@Override
    ...
    public void onClick(View v) {
    	...
    	intEmail.putExtra(android.content.Intent.EXTRA_SUBJECT, "Fehler/Ergänzung in Transformator");
